      ...
      <div class="subscription-form">
          <div class="media-wrapper">
              ...
              <div class="subscription__input">
                  <form>
                      <input type="email" placeholder="Type your email address here…" name="subscription">
                      <button type="submit" name="subscription"><svg width="20" height="12" viewBox="0 0 24 14" fill="none" xmlns="http://www.w3.org/2000/svg">
